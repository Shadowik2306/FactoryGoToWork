...
namespace FactoryBusinessLogic.OfficePackage.Implements
{
    ...
    public class SaveToPdf : AbstractSaveToPdf
    {
        ...
        protected override void CreatePdf(PdfInfoMaster info)
        {
            //создаём документ
        ...
        protected override void SavePdf(PdfInfoMaster info)
        {
